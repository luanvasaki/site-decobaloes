...
export function WhatsAppButton({
  ...
  const variantClasses = {
    solid: 'bg-[#25D366] text-white hover:bg-[#1ea952]',
  ...
  return (
    <motion.a
      ...
      className={`inline-flex items-center gap-2 rounded-2xl font-bold transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-[#25D366]/30 ${sizeClasses[size]} ${variantClasses[variant]} ${className}`}
    >
      <svg
