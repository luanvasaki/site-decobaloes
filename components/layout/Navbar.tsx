      ...
      <nav className="container mx-auto px-4 h-16 flex items-center justify-between max-w-6xl">
        ...
        <div className="hidden md:flex">
          <a
            ...
            className="px-5 py-2 rounded-2xl text-sm font-bold bg-whatsapp text-white hover:bg-whatsapp-dark transition-all duration-200 shadow-sm"
          >
            Pedir orçamento
          </a>
        </div>
            ...
            <ul className="container mx-auto px-4 py-4 flex flex-col gap-1">
              ...
              <li className="mt-2">
                <a
                  ...
                  rel="noopener noreferrer"
                  onClick={() => setOpen(false)}
                  className="block text-center px-4 py-3 rounded-2xl text-sm font-bold bg-whatsapp text-white hover:bg-whatsapp-dark transition-all"
                >
                  Pedir orçamento
                </a>
              </li>
